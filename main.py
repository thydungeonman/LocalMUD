...
def launch(stdscr, player):
    ...
    while True:
        ...
        if choice == "quit":
            ...
            stdscr.nodelay(False)      # Make sure input is blocking
            ...
            try:
                stdscr.getkey()        # Wait for key press
            except Exception:
                stdscr.getch()         # Fallback if getkey fails

            # 🔁 Loop until a valid character is created
            new_player = None
            ...
            player = new_player  # ✅ Assign finalized character
